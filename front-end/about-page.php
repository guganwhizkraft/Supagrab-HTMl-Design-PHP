<?php include_once 'header.php'; ?>
    ...
    <section class="about-page section-b-space">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="banner-section"><img src="../assets/images/custom/Supagrab-Sale-.png"
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="team-4">
                        <div>
                            <div>
                                <img src="../assets/images/custom/about_team_a-min.png" class="img-fluid blur-up lazyload bg-img" alt="">
                            </div>
                            <h4>Hileri Keol</h4>
                        ...
                        <div>
                            <div>
                                <img src="../assets/images/custom/about_team_b-min.png" class="img-fluid blur-up lazyload bg-img" alt="">
                            </div>
                            <h4>Hileri Keol</h4>
                            <h6>CEo & Founder At Company</h6>
                        </div>
                        <div>
                            <div>
                                <img src="../assets/images/custom/about_team_c-min.png" class="img-fluid blur-up lazyload bg-img" alt="">
                            </div>
                            <h4>Hileri Keol</h4>
                            <h6>CEo & Founder At Company</h6>
                        </div>
