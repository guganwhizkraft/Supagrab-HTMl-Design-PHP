        ...
        <div class="row search-product">
            ...
            <div class="col-xl-2 col-md-4 col-6">
                <div class="product-box">
                    <div class="img-wrapper">
                        <div class="front">
                            <a href="product-page(left-image).php"><img src="../assets/images/custom/20210414_170713-min.jpg"
                                                                        class="img-fluid   bg-img" alt=""></a>
                        </div>
                        <div class="back">
                            <a href="product-page(left-image).php"><img src="../assets/images/custom/20210414_170713-min.jpg"
            ...
            <div class="col-xl-2 col-md-4 col-6">
                <div class="product-box">
                    <div class="img-wrapper">
                        <div class="front">
                            <a href="product-page(left-image).php"><img src="../assets/images/custom/20210414_170609-min.jpg"
                                                                        class="img-fluid   bg-img" alt=""></a>
                        </div>
                        <div class="back">
                            <a href="product-page(left-image).php"><img src="../assets/images/custom/20210414_170609-min.jpg"
