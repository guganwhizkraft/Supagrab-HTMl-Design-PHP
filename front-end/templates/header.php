...
<html lang="en">
    ...
    <head>
        ...
        <link rel="icon" href="../assets/images/custom/fav.png" type="image/x-icon">
        <link rel="shortcut icon" href="../assets/images/custom/fav.png" type="image/x-icon">
        <title>Supagrab | Buy Artificial Jewelry Online</title>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="header-contact">
                                <ul>
                                    <li>Welcome to Supagrab</li>
                                    <li><i class="fa fa-phone" aria-hidden="true"></i>Call Us: +0 000 0 00000</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="main-menu">
                            <div class="menu-left">
                                <div class="brand-logo">
                                    <a href="index.php">
                                        <img src="../assets/images/custom/supagrab-logo.png" class="img-fluid  " alt="">
                                    </a>
                                </div>
                            </div>
                                    ...
                                    <div class="icon-nav">
                                        <ul>
                                            <li class="onhover-div mobile-search">
                                                <div><a href="search.php"><img src="../assets/images/icon/search.png" class="img-fluid  " alt=""> <i class="ti-search"
                                                                                                                                                     ></i></a></div>                                            
                                            </li>                                       
