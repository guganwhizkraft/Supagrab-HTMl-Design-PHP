                    ...
                    <div class="row">
                        <div class="col-12 p-0">
                            <div class="slider-right-nav">
                                <div><img src="../assets/images/custom/20210414_201442-min.jpg" alt=""
                                          class="img-fluid  "></div>
                                <div><img src="../assets/images/custom/20210414_174357-min-1.jpg" alt=""
                                          class="img-fluid  "></div>
                                <div><img src="../assets/images/custom/20210424_125241-min.jpg" alt=""
                                          class="img-fluid  "></div>
                                <div><img src="../assets/images/custom/20210424_125511-min.jpg" alt=""
                                          class="img-fluid  "></div>
                            </div>
                        </div>
                    </div>
...
<!-- product-tab starts -->
<section class="tab-product m-0 single_pro_tabs">
    <div class="container">
        <div class="row">
...
<section class="section-b-space ratio_asos related_section">
    <div class="container">
        <div class="row">
        ...
        <div class="row search-product">
            <div class="col-xl-3 col-md-3 col-6">
                <div class="product-box">
                    <div class="img-wrapper">
                        <div class="front">
                            <a href="product-page(left-image).php"><img src="../assets/images/custom/2-min-5.jpg"
                                                                        class="img-fluid   bg-img" alt=""></a>
                        </div>
                        <div class="back">
                            <a href="product-page(left-image).php"><img src="../assets/images/custom/4-min-6.jpg"
                                                                        class="img-fluid   bg-img" alt=""></a>
                        </div>
            ...
            <div class="col-xl-3 col-md-3 col-6">
                <div class="product-box">
                    <div class="img-wrapper">
                        <div class="front">
                            <a href="product-page(left-image).php"><img src="../assets/images/custom/3-min-24-1.jpg"
                                                                        class="img-fluid   bg-img" alt=""></a>
                        </div>
                        <div class="back">
                            <a href="product-page(left-image).php"><img src="../assets/images/custom/3-min-14.jpg"
                                                                        class="img-fluid   bg-img" alt=""></a>
                        </div>
                        <div class="cart-info cart-wrap">
                            <button data-bs-toggle="modal" data-bs-target="#addtocart" title="Add to cart"><i
            ...
            <div class="col-xl-3 col-md-3 col-6">
                <div class="product-box">
                    <div class="img-wrapper">
                        <div class="front">
                            <a href="product-page(left-image).php"><img src="../assets/images/custom/1-min-24-1.jpg"
                                                                        class="img-fluid   bg-img" alt=""></a>
                        </div>
                        <div class="back">
                            <a href="product-page(left-image).php"><img src="../assets/images/custom/2-min-6.jpg"
                                                                        class="img-fluid   bg-img" alt=""></a>
                        </div>
                        <div class="cart-info cart-wrap">
                            <button data-bs-toggle="modal" data-bs-target="#addtocart" title="Add to cart"><i
