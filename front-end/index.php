...
<!-- Home slider -->
<section class="new_homebanner">
	<div class="container">
		<div class="row">
			<div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
				<div class="home-bnn_inner">
					<div class="banner-content_home">
						<h2>Exclusive Offer</h2>
					</div>
					<div class="banner_para_home">
						<p>10% OFF ON ALL PRODUCTS</p>
					</div>
					<div class="banner_button_home">
						<a class="btn bgimg_button" href="https://supagrab.com/shop/">SHOP NOW</a>
					</div>
				</div>
			</div>
		</div>
...
<!-- Paragraph-->
<div class="title1 section-t-space shop_heading">
    <h4>special offer</h4>
    <h2 class="title-inner1">SHOP NEW ARRIVALS</h2>
</div>    
<!-- Paragraph end -->
<!-- Product slider -->
<section class="section-b-space pt-0 ratio_asos shop_prod">
    <div class="container">
        <div class="row">
            <div class="col">
                <div class="product-4 product-m no-arrow">
                    <div class="product-box">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="product-page(left-image).php"><img src="../assets/images/custom/1-min-2-1.jpg"
                                                                             class="img-fluid   bg-img" alt=""></a>
                            </div>
                            <div class="back">
                                <a href="product-page(left-image).php"><img src="../assets/images/custom/1-min-8.jpg"
                                                                             class="img-fluid   bg-img" alt=""></a>
                            </div>
                    ...
                    <div class="product-box">
                        <div class="img-wrapper">
                            ...
                            <div class="front">
                                <a href="product-page(left-image).php">
                                    <img src="../assets/images/custom/20210424_125511-min.jpg" class="img-fluid   bg-img"
                                         alt=""></a>
                            </div>
                            <div class="back">
                                <a href="product-page(left-image).php"><img src="../assets/images/custom/20210424_125241-min.jpg"
                                                                             class="img-fluid   bg-img" alt=""></a>
                            </div>
                            <div class="cart-info cart-wrap">
                    ...
                    <div class="product-box">
                        <div class="img-wrapper">
                            <div class="lable-block"><span class="lable3">new</span> <span class="lable4">on
                                    sale</span></div>
                            <div class="front">
                                <a href="product-page(left-image).php"><img src="../assets/images/custom/1-min-12.jpg"
                                                                             class="img-fluid   bg-img" alt=""></a>
                            </div>
                            <div class="back">
                                <a href="product-page(left-image).php"><img src="../assets/images/custom/1-min-13.jpg"
                                                                             class="img-fluid   bg-img" alt=""></a>
                            </div>
                            <div class="cart-info cart-wrap">
                                <button data-bs-toggle="modal" data-bs-target="#addtocart" title="Add to cart"><i
                    ...
                    <div class="product-box">
                        <div class="img-wrapper">
                            <div class="lable-block"><span class="lable3">new</span> <span class="lable4">on
                                    sale</span></div>
                            <div class="front">
                                <a href="product-page(left-image).php"><img src="../assets/images/custom/1-min-22.jpg"
                                                                             class="img-fluid   bg-img" alt=""></a>
                            </div>
                            <div class="back">
                                <a href="product-page(left-image).php"><img src="../assets/images/custom/1-min-25-1.jpg"
                                                                             class="img-fluid   bg-img" alt=""></a>
                            </div>
                            <div class="cart-info cart-wrap">
                                <button data-bs-toggle="modal" data-bs-target="#addtocart" title="Add to cart"><i
                    ...
                    <div class="product-box">
                        <div class="img-wrapper">
                            ...
                            <div class="back">
                                <a href="product-page(left-image).php"><img src="../assets/images/custom/20210424_173907-min.jpg"
                                                                             class="img-fluid   bg-img" alt=""></a>
                            </div>
                            <div class="cart-info cart-wrap">
                                <button data-bs-toggle="modal" data-bs-target="#addtocart" title="Add to cart"><i
...
<!-- Parallax banner -->
<section class="obsession_banner" style="background-image: url('../assets/images/custom/Banner-min-1.jpg')";>
	<div class="container">
		<div class="row">
			<div class="mob_hide col-xl-6"></div>
			<div class="col-sm-12 col-md-12 col-lg-12 col-xl-6">
				<div class="obsession_main">
					<div class="obsession_inner">
						<div class="obsession_heading">
							<h3>LATEST OBSESSION</h3>
						</div>
						<div class="banner-content">
							<h2>THE PERFECT WOMEN'S JEWELRY</h2>
						</div>
						<div class="banner_para">
							<p>For the first time ever, our best selling fit meets your comfiest</p>
						</div>
						<div class="banner_button">
							<button class="btn fullblack_button">Make ‘em Yours</button>
						</div>
					</div>
				</div>
			</div>
...
<!-- blog section -->
<div class="container accessories_heading">
    <div class="row">
        <div class="col">
            <div class="title1 section-t-space">
                <h4>latest</h4>
                <h2 class="title-inner1">ACCESSORIES</h2>
            </div>
        </div>
    </div>
</div>
<section class="blog pt-0 ratio2_3 accessories_prod">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="slide-3 no-arrow slick-default-margin">
                    <div class="col-md-12">
                        <a href="#">
                            <div class="classic-effect">
                                <div>
                                    <img src="../assets/images/custom/Cosmetic.jpg" class="img-fluid   bg-img"
                                         alt="">
                                </div>
                                <span></span>
                            </div>
                    ...
                    <div class="col-md-12">
                        <a href="#">
                            <div class="classic-effect">
                                <div>
                                    <img src="../assets/images/custom/Earrings-2.jpg" class="img-fluid   bg-img"
                                         alt="">
                                </div>
                                <span></span>
                            </div>
                    ...
                    <div class="col-md-12">
                        <a href="#">
                            <div class="classic-effect">
                                <div>
                                    <img src="../assets/images/custom/Necklace-2.jpg" class="img-fluid   bg-img"
                                         alt="">
                                </div>
                                <span></span>
                            </div>
                    ...
                    <div class="col-md-12">
                        <a href="#">
                            <div class="classic-effect">
                                <div>
                                    <img src="../assets/images/custom/Ring-2.jpg" class="img-fluid   bg-img"
                                         alt="">
                                </div>
                                <span></span>
                            </div>
                    ...
                    <div class="col-md-12">
                        <a href="#">
                            <div class="classic-effect">
                                <div>
                                    <img src="../assets/images/custom/Bracelet-2.jpg" class="img-fluid   bg-img"
                                         alt="">
                                </div>
                                <span></span>
                            </div>
                    ...
                    <div class="col-md-12">
                        <a href="#">
                            <div class="classic-effect">
                                <div>
                                    <img src="../assets/images/custom/Keychain.jpg" class="img-fluid   bg-img"
                                         alt="">
                                </div>
                                <span></span>
                            </div>
                    ...
                    <div class="col-md-12">
                        <a href="#">
                            <div class="classic-effect">
                                <div>
                                    <img src="../assets/images/custom/Kids.jpg" class="img-fluid   bg-img"
                                         alt="">
                                </div>
                                <span></span>
                            </div>
                            ...
                            <div class="no-slider row">
                                <div class="product-box">
                                    <div class="img-wrapper">
                                        ...
                                        <div class="front">
                                            <a href="product-page(left-image).php"><img
